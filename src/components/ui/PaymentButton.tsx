...
const PaymentButton: FC<{
  ...
  return (
    <View className="absolute bottom-8  px-3 py-5 shadow-md bg-white w-full rounded">
      <View className="flex-row items-center justify-between">
        ...
        <View>
          <View className="flex-row items-center gap-3">
            <Text className="text-gray-500 line-through font-okra font-medium text-lg">
      ...
      <TouchableOpacity
        onPress={onPay}
        className="bg-red-500 my-4 rounded-xl justify-center items-center p-3">
